        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-1 bg-white">
          ...
          {mainArticle && (
            ...
            >
              ...
              <img 
                src={mainArticle.featured_image || "https://images.unsplash.com/photo-1621504450181-5d356f61d307?q=70&w=800&auto=format&fit=crop"} 
          ...
          <div className="lg:col-span-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-1">
            {sideArticles.map((article, index) => (
              ...
              >
                ...
                <img 
                  src={article.featured_image || "https://images.unsplash.com/photo-1596526131083-e8c633c948d2?q=70&w=500&auto=format&fit=crop"} 
                  alt={article.title} 
                  loading="lazy"
                  referrerPolicy="no-referrer"
                  className="absolute inset-0 h-full w-full object-cover transform group-hover:scale-[1.02] transition-transform duration-700 ease-out"
